...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _photoPath = widget.currentPhotoPath.isNotEmpty
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        // Devuelve los datos actualizados a HomeScreen
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                // Solo números, máximo 9 dígitos (formato chileno)
                inputFormatters: [
                ...
                validator: (v) {
                  ...
                  if (v.length != 9) return 'Debe tener 9 dígitos (ej: 912345678)';
